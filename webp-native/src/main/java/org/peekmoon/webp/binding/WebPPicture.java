...
public class WebPPicture {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPEncode.C_INT.withName("use_argb"),
        LibWebPEncode.C_INT.withName("colorspace"),
        LibWebPEncode.C_INT.withName("width"),
        LibWebPEncode.C_INT.withName("height"),
        LibWebPEncode.C_POINTER.withName("y"),
        LibWebPEncode.C_POINTER.withName("u"),
        LibWebPEncode.C_POINTER.withName("v"),
        LibWebPEncode.C_INT.withName("y_stride"),
        LibWebPEncode.C_INT.withName("uv_stride"),
        LibWebPEncode.C_POINTER.withName("a"),
        LibWebPEncode.C_INT.withName("a_stride"),
        MemoryLayout.sequenceLayout(2, LibWebPEncode.C_INT).withName("pad1"),
        MemoryLayout.paddingLayout(4),
        LibWebPEncode.C_POINTER.withName("argb"),
        LibWebPEncode.C_INT.withName("argb_stride"),
        MemoryLayout.sequenceLayout(3, LibWebPEncode.C_INT).withName("pad2"),
        LibWebPEncode.C_POINTER.withName("writer"),
        LibWebPEncode.C_POINTER.withName("custom_ptr"),
        LibWebPEncode.C_INT.withName("extra_info_type"),
        MemoryLayout.paddingLayout(4),
        LibWebPEncode.C_POINTER.withName("extra_info"),
        LibWebPEncode.C_POINTER.withName("stats"),
        LibWebPEncode.C_INT.withName("error_code"),
        MemoryLayout.paddingLayout(4),
        LibWebPEncode.C_POINTER.withName("progress_hook"),
        LibWebPEncode.C_POINTER.withName("user_data"),
        MemoryLayout.sequenceLayout(3, LibWebPEncode.C_INT).withName("pad3"),
        MemoryLayout.paddingLayout(4),
        LibWebPEncode.C_POINTER.withName("pad4"),
        LibWebPEncode.C_POINTER.withName("pad5"),
        MemoryLayout.sequenceLayout(8, LibWebPEncode.C_INT).withName("pad6"),
        LibWebPEncode.C_POINTER.withName("memory_"),
        LibWebPEncode.C_POINTER.withName("memory_argb_"),
        MemoryLayout.sequenceLayout(2, LibWebPEncode.C_POINTER).withName("pad7")
