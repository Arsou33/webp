...
public class WebPDecBuffer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPDecode.C_INT.withName("colorspace"),
        LibWebPDecode.C_INT.withName("width"),
        LibWebPDecode.C_INT.withName("height"),
        LibWebPDecode.C_INT.withName("is_external_memory"),
        WebPDecBuffer.u.layout().withName("u"),
        MemoryLayout.sequenceLayout(4, LibWebPDecode.C_INT).withName("pad"),
        LibWebPDecode.C_POINTER.withName("private_memory")
