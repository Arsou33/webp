...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPDecode.C_LONG.withName("__sig"),
        LibWebPDecode.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, LibWebPDecode.C_CHAR).withName("__opaque")
