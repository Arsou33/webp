...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPDecode.C_POINTER.withName("__routine"),
        LibWebPDecode.C_POINTER.withName("__arg"),
        LibWebPDecode.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = LibWebPDecode.upcallHandle(__routine.Function.class, "apply", $DESC);
