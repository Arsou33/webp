...
public class WebPMemoryWriter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPEncode.C_POINTER.withName("mem"),
        LibWebPEncode.C_LONG.withName("size"),
        LibWebPEncode.C_LONG.withName("max_size"),
        MemoryLayout.sequenceLayout(1, LibWebPEncode.C_INT).withName("pad"),
