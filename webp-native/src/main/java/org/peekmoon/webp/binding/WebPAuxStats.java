...
public class WebPAuxStats {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPEncode.C_INT.withName("coded_size"),
        MemoryLayout.sequenceLayout(5, LibWebPEncode.C_FLOAT).withName("PSNR"),
        MemoryLayout.sequenceLayout(3, LibWebPEncode.C_INT).withName("block_count"),
        MemoryLayout.sequenceLayout(2, LibWebPEncode.C_INT).withName("header_bytes"),
        MemoryLayout.sequenceLayout(3, MemoryLayout.sequenceLayout(4, LibWebPEncode.C_INT)).withName("residual_bytes"),
        MemoryLayout.sequenceLayout(4, LibWebPEncode.C_INT).withName("segment_size"),
        MemoryLayout.sequenceLayout(4, LibWebPEncode.C_INT).withName("segment_quant"),
        MemoryLayout.sequenceLayout(4, LibWebPEncode.C_INT).withName("segment_level"),
        LibWebPEncode.C_INT.withName("alpha_data_size"),
        LibWebPEncode.C_INT.withName("layer_data_size"),
        LibWebPEncode.C_INT.withName("lossless_features"),
        LibWebPEncode.C_INT.withName("histogram_bits"),
        LibWebPEncode.C_INT.withName("transform_bits"),
        LibWebPEncode.C_INT.withName("cache_bits"),
        LibWebPEncode.C_INT.withName("palette_size"),
        LibWebPEncode.C_INT.withName("lossless_size"),
        LibWebPEncode.C_INT.withName("lossless_hdr_size"),
        LibWebPEncode.C_INT.withName("lossless_data_size"),
        MemoryLayout.sequenceLayout(2, LibWebPEncode.C_INT).withName("pad")
