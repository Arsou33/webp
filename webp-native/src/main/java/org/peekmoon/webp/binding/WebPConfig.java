...
public class WebPConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPEncode.C_INT.withName("lossless"),
        LibWebPEncode.C_FLOAT.withName("quality"),
        LibWebPEncode.C_INT.withName("method"),
        LibWebPEncode.C_INT.withName("image_hint"),
        LibWebPEncode.C_INT.withName("target_size"),
        LibWebPEncode.C_FLOAT.withName("target_PSNR"),
        LibWebPEncode.C_INT.withName("segments"),
        LibWebPEncode.C_INT.withName("sns_strength"),
        LibWebPEncode.C_INT.withName("filter_strength"),
        LibWebPEncode.C_INT.withName("filter_sharpness"),
        LibWebPEncode.C_INT.withName("filter_type"),
        LibWebPEncode.C_INT.withName("autofilter"),
        LibWebPEncode.C_INT.withName("alpha_compression"),
        LibWebPEncode.C_INT.withName("alpha_filtering"),
        LibWebPEncode.C_INT.withName("alpha_quality"),
        LibWebPEncode.C_INT.withName("pass"),
        LibWebPEncode.C_INT.withName("show_compressed"),
        LibWebPEncode.C_INT.withName("preprocessing"),
        LibWebPEncode.C_INT.withName("partitions"),
        LibWebPEncode.C_INT.withName("partition_limit"),
        LibWebPEncode.C_INT.withName("emulate_jpeg_size"),
        LibWebPEncode.C_INT.withName("thread_level"),
        LibWebPEncode.C_INT.withName("low_memory"),
        LibWebPEncode.C_INT.withName("near_lossless"),
        LibWebPEncode.C_INT.withName("exact"),
        LibWebPEncode.C_INT.withName("use_delta_palette"),
        LibWebPEncode.C_INT.withName("use_sharp_yuv"),
        LibWebPEncode.C_INT.withName("qmin"),
        LibWebPEncode.C_INT.withName("qmax")
    ).withName("WebPConfig");
