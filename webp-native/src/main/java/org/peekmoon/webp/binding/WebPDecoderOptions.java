...
public class WebPDecoderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LibWebPDecode.C_INT.withName("bypass_filtering"),
        LibWebPDecode.C_INT.withName("no_fancy_upsampling"),
        LibWebPDecode.C_INT.withName("use_cropping"),
        LibWebPDecode.C_INT.withName("crop_left"),
        LibWebPDecode.C_INT.withName("crop_top"),
        LibWebPDecode.C_INT.withName("crop_width"),
        LibWebPDecode.C_INT.withName("crop_height"),
        LibWebPDecode.C_INT.withName("use_scaling"),
        LibWebPDecode.C_INT.withName("scaled_width"),
        LibWebPDecode.C_INT.withName("scaled_height"),
        LibWebPDecode.C_INT.withName("use_threads"),
        LibWebPDecode.C_INT.withName("dithering_strength"),
        LibWebPDecode.C_INT.withName("flip"),
        LibWebPDecode.C_INT.withName("alpha_dithering_strength"),
        MemoryLayout.sequenceLayout(5, LibWebPDecode.C_INT).withName("pad")
